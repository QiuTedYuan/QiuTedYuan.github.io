            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbar-menu">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="inactive" id="blog"><a href="blog/index.html">Blog</a></li>
                    </ul>
                </div>
            </div>
        </nav>`;
...
window.addEventListener("DOMContentLoaded", function () {
    if (document.getElementById("pub-list")) {
        ...
        publist.push({
            ...
            link: '[<a href="https://openreview.net/forum?id=piM21sPyVL" target="_blank">PDF</a>] [<a href="file/slides/neurips25.pptx" target="_blank">Slides</a>]',
        }, {
            conf: "NeurIPS",
            ...
            fullConf: "Conference on Neural Information Processing Systems",
            fullDate: "December 2025",
            link: '[<a href="https://openreview.net/forum?id=AXlquRUO0S" target="_blank">PDF</a>]',
        }, {
            conf: "SIGMOD",
            authors: "<strong>Yuan Qiu</strong> and Ke Yi",
